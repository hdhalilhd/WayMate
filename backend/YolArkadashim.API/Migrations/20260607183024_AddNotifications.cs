        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    HomeAddressText = table.Column<string>(type: "text", nullable: false),
                    WorkAddressText = table.Column<string>(type: "text", nullable: false),
                    RadiusMeters = table.Column<int>(type: "integer", nullable: false),
                    EmailNotify = table.Column<bool>(type: "boolean", nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateIndex(
                name: "IX_SavedSearches_HomeLocation",
                table: "SavedSearches",
                column: "HomeLocation")
            ...
            migrationBuilder.CreateIndex(
                name: "IX_SavedSearches_WorkLocation",
                table: "SavedSearches",
                column: "WorkLocation")
                .Annotation("Npgsql:IndexMethod", "GIST");
        }
